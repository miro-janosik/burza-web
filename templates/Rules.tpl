...
<head>
    ...
    <title>MC Baba Klub - Burza - Pravidlá</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/Dashboard">MC Baba Klub - Burza - Pravidlá</a>
            </div>
            <!-- /.navbar-header -->
...
Všetky hračky a veci s cenou nad 15 eur sa nepredávajú fyzicky (do herne ich počas zberu nie je nutné priniesť), predávajúci ich môžu ponúkať prostredníctvom vytlačeného inzerátu s fotkou, cenou a číslom predávajúceho na nástenke v priestoroch herne</li>
        ...
        <li>Na burze je možné ponúkať oblečenie len podľa uvedenej sezóny</li>
				<li>Organizátorky si vyhradzujú právo nezaradiť položky do predaja podľa vlastného uváženia</li>
														...
														<li>MC Baba klub sa zaväzuje vytlačiť štítky a zabezpečiť predaj a propagáciu burzy, zároveň si však vyhradzuje právo z pádnych dôvodov prinesené veci neprevziať a do burzy  nezaradiť</li>
														<li>Peniaze z predaja budú v termíne určenom na výplatu vyplatené predávajúcemu, predávajúci sa zaväzuje darovať 15% z tejto čiastky MC Baba klub</li>
														<li>MC Baba klub za predávaný tovar a prípadné straty NERUČÍ. V prípade neprevzatia sa nepredané oblečenie a peniaze dňom {$LikvidaciaDatum} stávajú majetkom MC Baba klub</li>
													</ul>
                          <br>
                          <h1>Harmonogram burzy</h1>
                            ...
                            <p><br><a class="btn btn-info btn-lg" href="/">Burza</a></p>
                    </div>
                    <!-- /.panel -->
                </div>
                <!-- /.col-lg-12 -->
