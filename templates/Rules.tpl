...
<li>Organizátor si vyhradzuje právo prebrať iba veci označené predávajúcim, pričom označenie musí obsahovať :  kód, poradové číslo a cenu.
<br/></br>
Odporúčame tieto tri údaje napísať na látkovú stužku a prišiť na príslušný kus oblečenia. V prípade topánok alebo súpravy treba tieto dobre spojiť, označiť obidva kusy rovnakými údajmi.  Na väčšie predávané kusy tovaru je potrebné viditeľne a bezpečne umiestniť značenie /značenie rozumej: kód, číslo predávanej veci a cena v €./<br/>
Ak nebudú predávané veci označené spôsobom, ktorý spĺňa hore uvedené požiadavky, organizátor nebude zodpovedať za prípadnú stratu veci.</li>

<li>Neoznačené veci organizátor z organizačných dôvodov nepreberie</li>

<li>Organizátor nezodpovedá za prípadné poškodenie predávaného artiklu spôsobené kupujúcimi.</li>

<li>Môžete priniesť aj veci na darovanie pre azylové domy, detské domovy, detské oddelenia a novorodenecké oddelenia nemocníc.</li>
</ul>
...
<li> Pri predajnej cene 0,10 € a nižšej neúčtujeme  manipulačný poplatok.</li>

<li>Tieto prostriedky budú použité na aktivity organizované  MC Srdiečko.</li>
