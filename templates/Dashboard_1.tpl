...
{include file="Slices/Header.tpl"}
        ...
        <div id="page-wrapper">
											...
											<div class="panel panel-default">
													...
													<div id="collapseTwo" class="panel-collapse collapse">
														...
														<div class="table-responsive">
															<table class="table table-striped"><tbody class="lead">
																<tr><td><b>02.03. - 07.03.</b></td><td>Registrácia a vyplnenie zoznamu</td></tr>
																<tr><td><b>07.03. o 23:59</b></td><td>Uzávierka zoznamov (po tomto termíne už nebude možné zoznam upravovať)</td></tr>
																<tr><td><b>09.03. - 13.03.</b></td><td>Štítkovanie</td></tr>
																<tr><td><b>13.03. popoludní a 14.03. večer</b></td><td>Vyloženie tovaru (ak máte záujem nám s vykládkou pomôcť, kontaktujte nás)</td></tr>
																<tr><td><b>16.03. - 27.03.</b></td><td>Predaj</td></tr>
																<tr><td><b>27.03. popoludní</b></td><td>Spratanie burzy (ak máte záujem nám so spratávaním pomôcť, kontaktujte nás)</td></tr>
																<tr><td><b>30.03. - 03.04.</b></td><td>Vyzdvihnutie nepredaných vecí a peňazí</td></tr>
																<tr><td><b>05.04.</b></td><td>likvidácia nevyzdvihnutých vecí</td></tr>
															</tbody></table>
														</div>
            ...
            <!-- /.row -->
						 ...
						 <div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<b>Stav zatiaľ nepredaných položiek</b>
									</div>
									<!-- /.panel-heading -->
									<div class="panel-body">
												...
												<div class="panel-heading">
													<div class="row">
														...
														<div class="col-xs-9 text-right">
															<div>{$PocetNepredanych} veci za celkovo</div>
															<div class="huge">{$NepredaneCelkom} €</div>
														</div>
													</div>
												</div>
											</div>
            ...
            <!-- /.row -->
						<div class="row">
							<div class="col-lg-12">
								<div class="panel panel-default">
									<div class="panel-heading">
										<b>Stav už predaných položiek</b>
									</div>
									<!-- /.panel-heading -->
									<div class="panel-body">
										<div class="col-lg-3 col-md-6">
											<div class="panel panel-success">
												<div class="panel-heading">
													<div class="row">
														...
														<div class="col-xs-9 text-right">
															<div>{$PocetPredanych} veci za celkovo</div>
                                ...
                                <div class="col-lg-8">
                                    <form role="form" action="{if isset($EditID)}/Edit/{$EditID}{else}/Dashboard{/if}" method="post">
                                        <div class="form-group{if isset($ERRVELKOST)} has-error{/if}">
                                            ...
                                            <select name="velkost" class="form-control">
                                                <option value="x" style="font-weight:bold">Vyber veľkosť</option>
                                                <option {if isset($Velkost) && $Velkost == 1}selected{/if} value="1">50, predčasniatko</option>
                                                <option {if isset($Velkost) && $Velkost == 2}selected{/if} value="2">56, novorodenec</option>
                                                <option {if isset($Velkost) && $Velkost == 3}selected{/if} value="3">62, 3 mesiace</option>
                                                <option {if isset($Velkost) && $Velkost == 4}selected{/if} value="4">68, 6 mesiacov</option>
                                                <option {if isset($Velkost) && $Velkost == 5}selected{/if} value="5">74, 6 až 9 mesiacov</option>
                                                <option {if isset($Velkost) && $Velkost == 6}selected{/if} value="6">S</option>
                                                <option {if isset($Velkost) && $Velkost == 7}selected{/if} value="7">M</option>
                                                <option {if isset($Velkost) && $Velkost == 8}selected{/if} value="8">L</option>
                                                <option {if isset($Velkost) && $Velkost == 9}selected{/if} value="9">XL</option>
                                                <option {if isset($Velkost) && $Velkost == 10}selected{/if} value="10">bez veľkosti</option>
                                            </select>                                            
                                        ...
                                        <div class="form-group{if isset($ERRDRUH)} has-error{/if}">
                                            <label>Druh (max. 10 znakov)</label>
                                            <input {if isset($Druh)}value="{$Druh}"{/if} name="druh" maxlength="10" type="text" class="form-control" placeholder="Napríklad: Nohavice, topánky">
																						{if isset($ERRDRUH)}<div class="alert alert-danger"><b>Chybne vyplnený druh!</b></div>{/if}
                                        </div>
                                        <div class="form-group{if isset($ERRPOPIS)} has-error{/if}">
                                            <label>Popis (max. 70 znakov)</label>
                                            <textarea name="popis" maxlength="70" class="form-control" rows="5">{if isset($Popis)}{$Popis}{/if}</textarea>
          ...
          {foreach from=$Polozky key=k item=v}
            <tr class="odd gradeX">
							<td>{if $ID === 0}<b>{$v['Cislo']}</b> &nbsp; &nbsp; {if $v['Predane'] === 1}<b>PREDANÉ</b>{else}<a href="/Predane/{$v['ID']}" class="btn btn-danger btn-xs">Predane</a>{/if}{else}{if $v['Predane'] === 1}<b>PREDANÉ</b>{else}<a href="/Delete/{$v['ID']}" class="btn btn-danger btn-xs">Zmazať</a> <a href="/Edit/{$v['ID']}" class="btn btn-warning btn-xs">Upraviť</a>{/if}{/if}</td>
								<td>{$v['Cislo']}</td>
                <td>{$v['Cena']} €</td>
                <td>{$v['Druh']}</td>
                <td>{$v['Velkost']}</td>
